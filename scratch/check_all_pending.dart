...
void main() async {
  ...
  final txUrl = Uri.parse("https://utujkxrobmzlvudpvapc.supabase.co/rest/v1/store_transactions?item_name=eq.Asstra&status=neq.ACCEPTED&select=*");
  ...
  print("Non-ACCEPTED transactions for Asstra (${data.length} found):");
  for (var tx in data) {
